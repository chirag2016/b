...
#### Employees/Users
```
GET    /employees/list             - List all employees (supports pagination)
GET    /employees/{id}             - Get employee by ID
POST   /employees/create           - Create new employee (admin)
PUT    /employees/{id}             - Update employee
DELETE /employees/{id}             - Delete employee (admin)

GET    /users                      - Alias for /employees/list (frontend-compatible)
```
...
GET    /leave/list                 - List leave requests
PUT    /leave/{id}/approve         - Approve leave (manager/admin)
PUT    /leave/{id}/reject          - Reject leave (manager/admin)

POST   /leave                      - Alias for apply (frontend-compatible)
POST   /leave/{id}/approve         - Approve via POST (frontend-compatible)
```

#### Holidays
```
GET    /holidays/list              - List all holidays
POST   /holidays/create            - Create holiday (admin)
```
...
- [Frontend README](frontend-only/README.md) - Frontend specific docs
- [PR Description](PR_DESCRIPTION.md) - Integration details
- [API Documentation](http://localhost:8000/docs) - Interactive Swagger UI (when running)
- [Frontend Setup Guide](frontend-only/SETUP_GUIDE.md) - Frontend setup instructions
- [FastAPI Integration](frontend-only/FASTAPI_INTEGRATION.md) - Integration notes
...
**Developed by:** Intern Project Team
...
- Inspect test files for API usage examples
